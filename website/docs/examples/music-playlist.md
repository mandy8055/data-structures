...
description: Music playlist with forward/backward playback using DoublyLinkedList
keywords: [doubly-linked-list, music, playlist, example]
---

# Music Playlist with DoublyLinkedList

Create a music playlist with forward and backward navigation.
...
- [Deque API Reference](../api/deque.md)
